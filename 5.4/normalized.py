# -*- coding: utf-8 -*-
"""
Created on Wed Jul 19 21:02:33 2023
...
cost_Elz = [600, 800, 1000] #电解槽单位投资成本 $/kW 
ratings = np.zeros((len(cost_Elz), 2))
for i in range(len(cost_Elz)):
    ratings[i,0], ratings[i,1]  = normalized(cost_Elz[i]) 
#保存数据
workbook = xlsxwriter.Workbook('D:/Doctor/paper/2023third/Last_Code/5.4/normalized_ratings11.xlsx')
#写入标题
worksheet = workbook.add_worksheet()
worksheet.write(0, 0, 'c_Elz($/kW)')
worksheet.write(0, 1, 'P_Elz(kW)')
worksheet.write(0, 2, 'N_BS')
worksheet.write(1, 0, cost_Elz[0])
worksheet.write(1, 1, ratings[0,0])
worksheet.write(1, 2, ratings[0,1])   

worksheet.write(2, 0, cost_Elz[1])
worksheet.write(2, 1, ratings[1,0])
worksheet.write(2, 2, ratings[1,1])  

worksheet.write(3, 0, cost_Elz[2])
worksheet.write(3, 1, ratings[2,0])
worksheet.write(3, 2, ratings[2,1])  
workbook.close()  
