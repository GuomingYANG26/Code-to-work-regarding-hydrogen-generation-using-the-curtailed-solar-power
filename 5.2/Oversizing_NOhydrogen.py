# -*- coding: utf-8 -*-
"""
Created on Wed Jul 19 14:01:22 2023
@email: yangguoming1995@gmail.com
@author: YANG Guoming
"""


#####---------采用传统方法对灵活光伏电站、电池储能和电解槽进行建模,没有氢气系统------------------
import pandas as pd
...
multiplier2 = np.linspace(3, 15, length_2_number)
...
#保存数据
workbook = xlsxwriter.Workbook('D:/Doctor/paper/2023third/Last_Code/5.2/Oversizing_NOhydrogen.xlsx')
